/** Base de connaissances Karmic Management (Roach, McNally, Gordon) — injectée dans le coach. */

export const KM_PRINCIPLES = `
...
export function getFallbackAdvice(step: number | 'afternoon'): string {
    const fallbacks: Record<string, string> = {
        '1': 'Formule ton intention en une phrase mesurable et positive. Ex : « Obtenir 3 nouveaux clients ce mois-ci » plutôt que « avoir plus de clients ».\n\n• Une seule phrase\n• Précise le délai ou le nombre\n• Formule au présent ou futur proche',
        '2': 'Cherche quelqu\'un qui veut la même chose que toi. C\'est ton partenaire karmique — le « sol » où tu plantes la graine.\n\n• Liste 2 collègues ou contacts avec un objectif similaire\n• Choisis celui que tu peux aider concrètement cette semaine\n• Écris un plan d\'aide en 1 heure minimum',
        '3': 'Choisis le domaine qui correspond le mieux à ton intention et décris une action CONCRÈTE pour ton partenaire aujourd\'hui.\n\n• Une action réalisable en moins de 2 heures\n• Directement utile à la personne choisie\n• Coche « j\'ai agi » si c\'est déjà fait',
        '4': 'Installe-toi confortablement. Rejouis-toi de l\'aide que tu as donnée ou prévue. Visualise ton intention déjà réalisée.\n\n• Respire 3 fois profondément\n• Revois l\'aide pour ton partenaire\n• Ressens la gratitude — c\'est l\'arrosage de la graine',
        afternoon: 'Regarde les parcelles les moins développées de ton jardin. Plante une graine libre dans ce domaine.\n\n• Relations faible → compliment ou écoute\n• Abondance faible → faire réussir quelqu\'un\n• Spiritualité → gratitude ou méditation',
    };
    return fallbacks[String(step)] ?? fallbacks['1'];
}
